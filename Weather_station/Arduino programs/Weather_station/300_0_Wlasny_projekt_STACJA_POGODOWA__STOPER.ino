...
void setup() {
  ...
  pinMode(9, INPUT_PULLUP);  //S1
  pinMode(8, INPUT_PULLUP);  //S2
  pinMode(10, INPUT_PULLUP);  //S3
...
if ((digitalRead(8) == LOW) && stoper == false) {
...
if ((digitalRead(9) == LOW) && stoper == false) {
...
if (stoper == true) {
if (digitalRead(8) == LOW && koniec == false && stoper == true) {
...
else if (digitalRead(9) == LOW && koniec == false && blokada == false && stoper == true) {
...
delay(500);
...
else if (digitalRead(8) == LOW && koniec == true && stoper == true) {
  ...
  delay(10);
  ////////////////////////////////////////////////////////////////////
  if (digitalRead(9) == LOW) {  //S2                         /// zmiana trybu pomiaru
  trybSuma = !trybSuma;
  delay(50);
  ...
  if (digitalRead(9) == LOW && dalej == true && trybSuma == false) {  //S2           /// zmiana czujnika
  tryb = !tryb;
  delay(50);
